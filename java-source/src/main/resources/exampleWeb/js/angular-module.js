...
app.controller('DemoAppController', function($http, $location, $uibModal) {
    ...
    demoApp.getMe = () => $http.get(apiBaseURL + "me").then((response) => demoApp.thisNode = response.data.me);
    ...
    demoApp.getMyIOUs = () => $http.get(`${apiBaseURL}ious-lender?lenderPartyName=${demoApp.thisNode}`)
